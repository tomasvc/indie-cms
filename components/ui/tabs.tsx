...
const tabsListVariants = cva(
  "rounded-lg p-[3px] group-data-[state=horizontal]/tabs:h-8 data-[variant=line]:rounded-none data-[variant=line]:p-0 data-[variant=line]:h-auto group/tabs-list text-muted-foreground inline-flex w-fit items-center justify-center group-data-[state=vertical]/tabs:h-fit group-data-[state=vertical]/tabs:flex-col",
  {
    variants: {
      variant: {
        default: "bg-muted",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "after:bg-foreground after:absolute after:opacity-0 after:transition-opacity after:h-0.5 after:rounded-full",
        "group-data-[state=horizontal]/tabs:after:inset-x-0 group-data-[state=horizontal]/tabs:after:bottom-0 group-data-[state=vertical]/tabs:after:inset-y-0 group-data-[state=vertical]/tabs:after:-right-1 group-data-[state=vertical]/tabs:after:w-0.5",
        "group-data-[state=vertical]/tabs-list:data-[state=active]:after:opacity-100",
        "group-data-[variant=line]/tabs-list:data-[state=active]:after:opacity-100",
        "group-data-[variant=line]/tabs-list:data-[state=active]:bg-transparent group-data-[variant=line]/tabs-list:data-[state=active]:border-transparent group-data-[variant=line]/tabs-list:data-[state=active]:text-foreground group-data-[variant=line]/tabs-list:dark:data-[state=active]:bg-transparent group-data-[variant=line]/tabs-list:dark:data-[state=active]:border-transparent",
        "group-data-[variant=line]/tabs-list:rounded-none group-data-[variant=line]/tabs-list:pb-0.5 group-data-[variant=line]/tabs-list:after:-bottom-0.5",
        className
      )}
      {...props}
    />
