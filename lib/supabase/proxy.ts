...
export async function updateSession(request: NextRequest) {
  ...
  const isDemo = request.nextUrl.searchParams.get("demo") === "true" || request.cookies.get("demo")?.value === "true";
  ...
  if (isDemo && !user && request.nextUrl.pathname !== "/auth/demo") {
    const res = NextResponse.redirect(new URL('/auth/demo', request.url));
